...
const SupportLinks: React.FC<SupportLinksProps> = ({ navigateTo }) => {
  return (
    <div className="flex flex-col md:grid md:grid-cols-3 items-stretch justify-center gap-2 sm:gap-3 md:gap-4 max-w-full sm:max-w-lg md:max-w-3xl mx-auto px-0 sm:px-2 md:px-4">
      <a href="https://ko-fi.com/saveytb" target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-center gap-2 py-2 sm:py-2.5 px-3 sm:px-4 bg-white dark:bg-[#2d2d2d] border border-gray-200 dark:border-gray-600 rounded-lg shadow-sm hover:bg-gray-100 dark:hover:bg-[#3a3a3a] transition-colors text-center text-xs sm:text-sm">
      ...
      <a href="https://paypal.me/SaveYTB" target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-center gap-2 py-2 sm:py-2.5 px-3 sm:px-4 bg-white dark:bg-[#2d2d2d] border border-gray-200 dark:border-gray-600 rounded-lg shadow-sm hover:bg-gray-100 dark:hover:bg-[#3a3a3a] transition-colors text-center text-xs sm:text-sm">
        <svg height="16px" viewBox="0 0 512 512" width="16px" className="w-4 h-4 sm:w-5 sm:h-5 text-gray-700 dark:text-gray-300 flex-shrink-0">
          <g>
      ...
      <button 
        ...
        className="w-full flex items-center justify-center gap-2 py-2 sm:py-2.5 px-3 sm:px-4 bg-white dark:bg-[#2d2d2d] border border-gray-200 dark:border-gray-600 rounded-lg shadow-sm hover:bg-gray-100 dark:hover:bg-[#3a3a3a] transition-colors text-center text-xs sm:text-sm"
      >
