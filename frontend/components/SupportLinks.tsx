...
const SupportLinks: React.FC<SupportLinksProps> = ({ navigateTo }) => {
  return (
    <div className="flex flex-col md:grid md:grid-cols-3 items-stretch justify-center gap-3 sm:gap-4 md:gap-4 max-w-full sm:max-w-lg md:max-w-2xl mx-auto px-0 sm:px-2 md:px-4">
      <a href="https://ko-fi.com/saveytb" target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-center gap-2 py-3 sm:py-3.5 md:py-2.5 px-4 sm:px-5 md:px-3 bg-white dark:bg-[#2d2d2d] border border-gray-200 dark:border-gray-600 rounded-lg shadow-sm hover:bg-gray-100 dark:hover:bg-[#3a3a3a] transition-colors text-center text-sm sm:text-base md:text-sm">
        <CoffeeIcon className="w-5 h-5 sm:w-6 sm:h-6 md:w-4 md:h-4 text-gray-700 dark:text-gray-300 flex-shrink-0" />
        <span className="font-semibold text-gray-700 dark:text-gray-300">Buy me a coffee</span>
      </a>
      <a href="https://paypal.me/SaveYTB" target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-center gap-2 py-3 sm:py-3.5 md:py-2.5 px-4 sm:px-5 md:px-3 bg-white dark:bg-[#2d2d2d] border border-gray-200 dark:border-gray-600 rounded-lg shadow-sm hover:bg-gray-100 dark:hover:bg-[#3a3a3a] transition-colors text-center text-sm sm:text-base md:text-sm">
        <svg height="20px" viewBox="0 0 512 512" width="20px" className="w-5 h-5 sm:w-6 sm:h-6 md:w-4 md:h-4 text-gray-700 dark:text-gray-300 flex-shrink-0">
          <g>
      ...
      <button 
        ...
        className="w-full flex items-center justify-center gap-2 py-3 sm:py-3.5 md:py-2.5 px-4 sm:px-5 md:px-3 bg-white dark:bg-[#2d2d2d] border border-gray-200 dark:border-gray-600 rounded-lg shadow-sm hover:bg-gray-100 dark:hover:bg-[#3a3a3a] transition-colors text-center text-sm sm:text-base md:text-sm"
      >
        <VideoIcon className="w-5 h-5 sm:w-6 sm:h-6 md:w-4 md:h-4 text-gray-700 dark:text-gray-300 flex-shrink-0" />
