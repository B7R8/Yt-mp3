      ...
      <div className="container mx-auto max-w-full sm:max-w-2xl md:max-w-4xl lg:max-w-5xl text-gray-500 dark:text-gray-400 px-2 sm:px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-4">
              Free YouTube to MP3 converter. Download high-quality MP3 audio from YouTube videos instantly. Convert YouTube to MP3, YouTube video to MP3, YT to MP3 with our YouTube to MP3 downloader.
            </p>
            <div className="flex justify-center md:justify-start gap-3">
              <a href="https://x.com/YtbSave" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-800 hover:bg-gray-900 rounded-full flex items-center justify-center transition-colors" aria-label="Follow SaveYTB on X (formerly Twitter)" title="Follow SaveYTB on X (formerly Twitter)">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://discord.com/invite/Y88BwYZxDu" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-indigo-600 hover:bg-indigo-700 rounded-full flex items-center justify-center transition-colors" aria-label="Join SaveYTB Discord community server" title="Join SaveYTB Discord community server">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://t.me/saveytb" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-blue-500 hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors" aria-label="Join SaveYTB Telegram channel" title="Join SaveYTB Telegram channel">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/>
                </svg>
              </a>
              <a href="https://reddit.com/r/saveytb" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-orange-600 hover:bg-orange-700 rounded-full flex items-center justify-center transition-colors" aria-label="Join SaveYTB Reddit community r/SaveYTB" title="Join SaveYTB Reddit community r/SaveYTB">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-4 text-center">
          <p className="text-xs text-gray-500 dark:text-gray-400">
            &copy; {currentYear} SaveYTB. All Rights Reserved. Free YouTube to MP3 converter & downloader.
          </p>
        </div>
      </div>
    </footer>
