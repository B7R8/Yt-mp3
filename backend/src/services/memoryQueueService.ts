...
export class MemoryQueueService extends EventEmitter {
  ...
  async isHealthy(): Promise<boolean> {
    try {
      ...
      logger.error('Memory queue health check failed:', error);
      return false;
    }
  }
}
...
export const memoryQueueService = new MemoryQueueService();
