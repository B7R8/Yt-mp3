...
exports.memoryQueueService = exports.MemoryQueueService = void 0;
const events_1 = require("events");
const memoryCache_1 = require("../config/memoryCache");
const logger_1 = __importDefault(require("../config/logger"));
class MemoryQueueService extends events_1.EventEmitter {
    ...
    async startProcessing() {
        ...
        logger_1.default.info('Memory queue processing started');
    ...
    async stopProcessing() {
        this.isProcessing = false;
        logger_1.default.info('Memory queue processing stopped');
    }
    ...
    async clearQueue() {
        try {
            ...
            logger_1.default.info('Memory queue cleared');
        }
        catch (error) {
    ...
    async isHealthy() {
        try {
            ...
            logger_1.default.error('Memory queue health check failed:', error);
            return false;
        }
    }
}
exports.MemoryQueueService = MemoryQueueService;
// Export singleton instance
exports.memoryQueueService = new MemoryQueueService();
exports.default = exports.memoryQueueService;
//# sourceMappingURL=memoryQueueService.js.map