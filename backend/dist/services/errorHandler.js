...
exports.sendErrorResponse = exports.logTechnicalError = exports.getUserFriendlyError = exports.ErrorHandler = void 0;
...
class ErrorHandler {
     ...
     */
    static logTechnicalError(error, operation, context) {
        const errorInfo = {
            operation,
        ...
        logger_1.default.error(`Technical Error [${operation}]:`, errorInfo);
    }
    /**
     * Handle conversion errors with proper fallbacks
     */
    static async handleConversionError(error, jobId, videoId, operation) {
     ...
     */
    static createErrorResponse(statusCode, userMessage, technicalError, context) {
        const response = {
            success: false,
            message: userMessage,
            timestamp: new Date().toISOString()
     ...
     */
    static async handleApiFailure(primaryError, fallbackAction, context) {
        logger_1.default.warn(`API failure handled with fallback: ${fallbackAction}`, {
            context,
...
exports.getUserFriendlyError = ErrorHandler.getUserFriendlyError;
exports.logTechnicalError = ErrorHandler.logTechnicalError;
const sendErrorResponse = (res, statusCode, userMessage, technicalError, context) => {
