...
export declare class MemoryQueueService extends EventEmitter {
    private queueName;
...
export declare const memoryQueueService: MemoryQueueService;
export default memoryQueueService;
//# sourceMappingURL=memoryQueueService.d.ts.map